...
@interface SLLaunchAdImageView ()

@end

@implementation SLLaunchAdImageView
...
@interface SLLaunchAdVideoView () <UIGestureRecognizerDelegate>

@property (nonatomic, strong) AVPlayerItem *playerItem;

@end

@implementation SLLaunchAdVideoView
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context {
    if ([keyPath isEqualToString:VideoPlayStatus]) {
        ...
        if (newStatus == AVPlayerItemStatusFailed) {
            [[NSNotificationCenter defaultCenter] postNotificationName:SLLaunchAdVideoPlayFailedNotification object:nil userInfo:@{@"videoNameOrURLString":_contentURL.absoluteString}];
        }
    }
}
...
- (void)setVideoGravity:(AVLayerVideoGravity)videoGravity {
    ...
    _videoPlayer.videoGravity = videoGravity.copy;
}
